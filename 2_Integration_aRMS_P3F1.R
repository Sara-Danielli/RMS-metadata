...
PDX.list <- SplitObject(P3F1.combined , split.by = "name")
PDX.list
...
saveRDS(PDX.integrated, file = "/mnt/Sara/write/Danielli_Patel_Langenau_RPCA_ARMS_P3F1.rds")



##################################################################
#  (2) Scoring P3F1 cells for gene sets:  #
##################################################################
...
PDX.integrated <- readRDS("/mnt/Sara/write/Danielli_Patel_Langenau_RPCA_ARMS_P3F1.rds")
PDX.integrated 
DefaultAssay(PDX.integrated) <- "integrated"
...
###### Save integrated dataset ###########
saveRDS(PDX.integrated, file.path(base_dir, "write/Danielli_Patel_Langenau_RPCA_ARMS_P3F1_scores.rds"))
PDX.integrated <- readRDS(file.path(base_dir, "write/Danielli_Patel_Langenau_RPCA_ARMS_P3F1_scores.rds"))

PDX.integrated <- PDX.combined
